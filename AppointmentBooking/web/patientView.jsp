...
<body>
    <% Patient patient = PatientDao.getPatientfromUser((int)session.getAttribute("userId")); %>
        
    

    <div class="welcome-message">
        Welcome, <span id="patientName"><%=patient.getName()%></span>!
    </div>
    ...
    <div class="button-container">
        ...
        <button class="action-button view-button" onclick="window.location.href='ViewAppointmentServlet'">View Appointments</button>
    </div>
